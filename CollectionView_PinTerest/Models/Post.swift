...
struct Post
{
    ...
    static func fetchPosts() -> [Post]
    {
        ...
        let duc1 = User(username: "Duc Tran", profileImage: UIImage(named: "3"))
        let duc2 = User(username: "Duc Tran", profileImage: UIImage(named: "6"))
        ...
        let post3 = Post(createdBy: duc1, timeAgo: "5 hrs", caption: "New iOS tutorial is up for developers out in the world: JoinDuc.com/iosapp-fb", image: UIImage(named: "3"), numberOfLikes: 8, numberOfComments: 92, numberOfShares: 89)
        ...
        let post5 = Post(createdBy: duc2, timeAgo: "8 hrs", caption: "No matter how small you start, start something that matters. Believe in your dreams and begin.", image: UIImage(named: "5"), numberOfLikes: 99, numberOfComments: 83, numberOfShares: 89)
        let post6 = Post(createdBy: duc1, timeAgo: "Yesterday", caption: "Congratulations to the graduating class of high performance academy 2017! Thank you for your engagement, joy and confidence. Now go serve the world!", image: UIImage(named: "6"), numberOfLikes: 9, numberOfComments: 82, numberOfShares: 74)
